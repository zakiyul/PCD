 ...
 * @author zaki
 */
public class BrightnessNContras extends javax.swing.JFrame {
...
//            ImageIcon imgIcon2 = new ImageIcon(loadImg, tampil_output.getWidth(), tampil_output.getHeight());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrightnessNContras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BrightnessNContras().setVisible(true);
            }
        });
    }
